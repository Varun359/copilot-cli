...
func (o *deployPipelineOpts) Execute() error {
	...
	if err := o.deployPipeline(deployPipelineInput, stCon); err != nil {
		return err
	}
	return nil
}
...
func (o *deployPipelineOpts) deployPipeline(in *deploy.CreatePipelineInput, stCon deploycfn.StackConfiguration) error {
	exist, err := o.pipelineDeployer.PipelineExists(in, stCon)
	if err != nil {
	...
	if !exist {
		...
		if err := o.pipelineDeployer.CreatePipeline(in, bucketName, stCon); err != nil {
	...
	if err := o.pipelineDeployer.UpdatePipeline(in, bucketName, stCon); err != nil {
